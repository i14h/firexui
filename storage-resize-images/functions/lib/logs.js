...
exports.readConfigFile = (path, config) => {
    firebase_functions_1.logger.log(`Read config file located at: '${path}':${JSON.stringify(config)}`);
};
exports.readingConfigFileFailed = (path) => {
    firebase_functions_1.logger.log(`Unable to read config file at: '${path}'`);
};
